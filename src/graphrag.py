# src/graphrag.py
# ─────────────────────────────────────────────────────────────────────────────
# The GraphRAG pipeline for the Hollywood Knowledge Graph.
#
# Pipeline stages:
...
SYSTEM_PROMPT = """You are an expert on Hollywood cinema with deep knowledge of English films,
...
def generate_answer(question: str, context: str) -> str:
    ...
    user_msg = f"""Based on the following Hollywood knowledge graph data, please answer:
...
def graphrag_answer(
    ...
    """
    Answer a question about Hollywood using the full GraphRAG pipeline.
...
if __name__ == "__main__":
    questions = [
        "Which films did Leonardo DiCaprio and Hans Zimmer collaborate on?",
        "Which actors worked under Christopher Nolan's direction?",
        "Which movies produced by Marvel Studios have Robert Downey Jr.?",
        "What Academy awards have films produced by Warner Bros. Pictures won?",
        "Which actors/actresses starred in films produced by Universal Pictures?",
    ]
